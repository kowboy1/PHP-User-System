<?php
	...
	echo $error;
?>
	<h1><?php echo _('Oops, Access Denied'); ?></h1>
	<h4><?php echo _('Sorry, your username or user group has been disabled!'); ?></h4>
	<p><?php  _('We have detected that your username or user group has been disabled; so you cannot view internal pages.'); ?></p>
	<p><?php  _('Fill out this form if you feel this is in error'); ?></p>
		...
		<label for="subject"><?php echo _('Subject'); ?></label>
			<div class="input">
			 <select name="subject" id="subject">
			  <option selected="selected" value="User / Group Disabled"><?php echo _('Disabled Message'); ?></option>
			  <option value="a Bug fix"><?php echo _('Report a bug'); ?></option>
			 </select>
			</div>
		</div><!-- /clearfix -->

		<div class="clearfix">
		<label for="comments" accesskey="C"><?php echo _('Your comments'); ?></label>
			<div class="input">
		...
		<div class="clearfix">
		<label for="verify"><?php echo _('What colour is the sky?'); ?></label>
			<div class="input">
				<input id="verify" name="verify" size="4" type="text" value="<?php if(isset($verify)) echo $verify;?>"/>
			</div>
		</div><!-- /clearfix -->

		<input name="contactus" type="submit" class="btn btn-primary" id="contactus" value="<?php echo _('Submit'); ?>" />
