 ...
 * http://phplogin.approveyourweb.site/documentation.php#/install-languages
 *
 * LICENSE:
 *
...
class Translate {
  ...
  private function setLang() {
    ...
    if (!isEmpty($_GET['lang'])){
      
      if ($this->displayName($_GET['lang'])){
        
        $this->lang = $_GET['lang'];
        $_SESSION['jigowatt']['language'] = $_GET['lang'];
      }
    }
    
    if(!isEmpty($_SESSION['jigowatt']['language'])){
      $this->lang = $_SESSION['jigowatt']['language'];
    }

    // ----------

    #putenv('LC_ALL=' . $this->lang . '.UTF8');
    putenv("LANGUAGE=" . $this->lang . '.UTF8');
