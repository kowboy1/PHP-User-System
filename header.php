...
<head>
  <title>PHP Login and User Management</title>
  ...
  <meta name="google-signin-client_id" content="970188327129-4teju0qc0ads9cenq9r3s7ffpfcfl72p.apps.googleusercontent.com">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="<?php echo BASE_URL . '/home.php'; ?>"><?php echo _('Home'); ?></a>
	    </div>
	    
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
				<li><a href="<?php echo BASE_URL . '/protected.php'; ?>"><?php echo _('Secure Page'); ?></a></li>
				<li><a href="<?php echo BASE_URL . '/admin/index.php'; ?>"><?php echo _('Control Panel'); ?></a></li>
			</ul>
		<?php if(isset($_SESSION['jigowatt']['username'])) { ?>
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
				<p class="navbar-text" id="userDrop">
		...
		<?php } else { ?>
		<ul class="nav navbar-nav navbar-right">
			<li><a href="<?php echo BASE_URL . '/login.php'; ?>" class="signup-link"><em><?php echo _('Have an account?'); ?></em> <strong><?php echo _('Sign in!'); ?></strong></a></li>
		</ul>
		<?php } ?>
   </div><!-- /.navbar-collapse -->
  </div><!-- /.container -->
		...
		<div class="container" >
			<div class="row">
				...
				<div class="col-md-12">
					...
					#$generic->displayMessage( $generic->get_error(), false ); # todo: uncomment this line? it exits the script ?>
